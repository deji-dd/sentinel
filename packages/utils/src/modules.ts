 ...
 */
export function normalizeModules(modules: string[] | null | undefined): ModuleKey[] {
...
export function isModuleEnabled(
  ...
  const normalized = normalizeModules(enabledModules);
  return normalized.includes(canonicalTarget);
}
