...
export type AssetCategory = "item" | "point" | "equity" | "property" | "company";
export type AssetLocation = "inventory" | "bazaar" | "display" | "equipped" | "escrow" | "armory" | "portfolio" | "property";
...
export type LedgerEventType = "purchase" | "sale" | "storage_transfer" | "injection" | "income" | "sink" | "barter" | "loss" | "init";

export interface LedgerEventDocument extends BaseDocument {
