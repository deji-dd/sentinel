 ...
 */
function deriveKeyFromMaster(masterKey) {
 ...
 */
export function decryptApiKey(encrypted, masterKey) {
    const derivedKey = deriveKeyFromMaster(masterKey);
    // Extract components
 ...
 */
export function hashApiKey(apiKey, pepper) {
 ...
 */
export async function ensureApiKeyMapped(apiKey, supabase, config) {
    ...
    try {
        ...
        console.log(`[ApiKeyManager] ✓ Created API key mapping for player ${userId}`);
