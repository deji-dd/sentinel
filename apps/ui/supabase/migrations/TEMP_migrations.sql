-- TEMP_migrations.sql
-- Current changes:
-- - Drop market/trade tables and worker seed
-- - Add torn items, destinations, travel times
...
-- Update workers seed: remove market_trends_worker, add torn_items_worker (daily cadence)
